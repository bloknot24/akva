...
<div class="box__breadcrumbs">
    <div class="section__size">
        <ul class="breadcrumbs__list">
            ...
            <li class="breadcrumbs__list-item upper">
                <a href="/mezhdunarodnye-perevozki" class="breadcrumbs__link">
    ...
    <div class="section__size">
        ...
        <div class="box__form-main" id="form__main-akva">
            <div class="form__main">
                <?php $headService = 'Международные перевозки';
                ...
                <form method="post" action="#form__main-akva">
                    ...
                    <div class="form__main-block">
                        ...
                        <div class="form__main-btn-block">
                            <input type="submit" name="formServiceShipping" class="form__main-btn upper" value="Отправить">
                        </div>
                    </div>
                </form>
